...
| [`lib/live-research.ts`](../lib/live-research.ts) | [`lib/catalog.ts`](../lib/catalog.ts)<br>[`lib/contracts.ts`](../lib/contracts.ts)<br>[`lib/errors.ts`](../lib/errors.ts)<br>[`lib/fixtures.ts`](../lib/fixtures.ts)<br>[`lib/openai.ts`](../lib/openai.ts)<br>[`lib/provider-usage.ts`](../lib/provider-usage.ts) |
...
| [`lib/starter-recommendations.ts`](../lib/starter-recommendations.ts) | [`db/index.ts`](../db/index.ts)<br>[`lib/catalog.ts`](../lib/catalog.ts)<br>[`lib/contracts.ts`](../lib/contracts.ts)<br>[`lib/openai.ts`](../lib/openai.ts)<br>[`lib/provider-usage.ts`](../lib/provider-usage.ts)<br>[`lib/request.ts`](../lib/request.ts)<br>[`lib/viewer.ts`](../lib/viewer.ts) |
