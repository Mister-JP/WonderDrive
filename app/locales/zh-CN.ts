const messages: Record<string, string> = {
  ...
  "Choose a current path.": "选择一个当前路径。",
  ...
  "Try different questions": "尝试不同的问题",
  "Change these choices": "更改这些选项",
  "Replacement question direction": "替换问题的方向",
  "Practical": "实用",
  "Surprising": "令人惊喜",
  "Different direction": "不同方向",
  "Optional note": "可选备注",
  "What should change about the replacement questions?": "替换问题应该如何调整？",
  "Replacing…": "正在替换…",
  "Generate replacement questions": "生成替换问题",
