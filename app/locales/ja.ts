const messages: Record<string, string> = {
  ...
  "Choose a current path.": "現在のパスを選択してください。",
  ...
  "Try different questions": "別の質問を試す",
  "Change these choices": "これらの選択肢を変更",
  "Replacement question direction": "代替の質問方向",
  "Practical": "実用的",
  "Surprising": "驚きのある",
  "Different direction": "異なる方向",
  "Optional note": "オプションのメモ",
  "What should change about the replacement questions?": "新しい質問をどのように変えますか？",
  "Replacing…": "置き換え中…",
  "Generate replacement questions": "新しい質問を生成",
