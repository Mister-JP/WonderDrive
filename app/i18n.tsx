...
const translations: Record<Exclude<SupportedLocale, "en">, Record<string, string>> = {
  es: {
    ...
    "Taking over research in this tab…": "Tomando el control de la investigación en esta pestaña…", "Use this tab": "Usar esta pestaña", "Research committed": "Investigación guardada", "Research stopped": "Investigación detenida", "Choose a current path.": "Elige un camino actual.",
    ...
    "Other ways to continue": "Otras formas de continuar", "Pick a path for me": "Elige un camino por mí", "CuriosityPedia chooses one": "CuriosityPedia elige uno", "Try different questions": "Probar preguntas distintas", "Change these choices": "Cambiar estas opciones", "Replacement question direction": "Dirección de las preguntas nuevas", Practical: "Práctica", Surprising: "Sorprendente", "Different direction": "Otra dirección", "Optional note": "Nota opcional", "What should change about the replacement questions?": "¿Qué debería cambiar en las preguntas nuevas?", "Replacing…": "Reemplazando…", "Generate replacement questions": "Generar preguntas nuevas",
...
const researchProgressTranslations: Record<Exclude<SupportedLocale, "en">, Record<string, string>> = {
  es: { "1 · Research dossier": "1 · Expediente de investigación", "2 · Compose answer": "2 · Redactar respuesta", "Check evidence": "Comprobar evidencia", "Research stages": "Etapas de investigación", "Research started. Keep this tab open; every completed stage is saved.": "La investigación comenzó. Mantén esta pestaña abierta; cada etapa terminada se guarda.", "Save journey": "Guardar recorrido", "This stage: attempt {attempt} of {max}": "Esta etapa: intento {attempt} de {max}", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "Puedes moverte por la aplicación mientras esta pestaña siga abierta. Cada etapa terminada se guarda; si la pestaña se desconecta, continuaremos desde el último punto guardado cuando vuelvas." },
  fr: { "1 · Research dossier": "1 · Dossier de recherche", "2 · Compose answer": "2 · Rédiger la réponse", "Check evidence": "Vérifier les preuves", "Research stages": "Étapes de recherche", "Research started. Keep this tab open; every completed stage is saved.": "La recherche a commencé. Gardez cet onglet ouvert ; chaque étape terminée est enregistrée.", "Save journey": "Enregistrer le parcours", "This stage: attempt {attempt} of {max}": "Cette étape : tentative {attempt} sur {max}", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "Vous pouvez naviguer dans l’application tant que cet onglet reste ouvert. Chaque étape terminée est enregistrée ; si l’onglet se déconnecte, nous reprendrons au dernier point enregistré à votre retour." },
  de: { "1 · Research dossier": "1 · Recherche-Dossier", "2 · Compose answer": "2 · Antwort verfassen", "Check evidence": "Belege prüfen", "Research stages": "Recherchephasen", "Research started. Keep this tab open; every completed stage is saved.": "Die Recherche wurde gestartet. Lass diesen Tab geöffnet; jede abgeschlossene Phase wird gespeichert.", "Save journey": "Journey speichern", "This stage: attempt {attempt} of {max}": "Diese Phase: Versuch {attempt} von {max}", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "Du kannst dich in der App bewegen, solange dieser Tab geöffnet bleibt. Jede abgeschlossene Phase wird gespeichert; bei einer Unterbrechung machen wir bei deiner Rückkehr am letzten Speicherpunkt weiter." },
  pt: { "1 · Research dossier": "1 · Dossiê de pesquisa", "2 · Compose answer": "2 · Compor resposta", "Check evidence": "Verificar evidências", "Research stages": "Etapas da pesquisa", "Research started. Keep this tab open; every completed stage is saved.": "A pesquisa começou. Mantenha esta aba aberta; cada etapa concluída é salva.", "Save journey": "Salvar jornada", "This stage: attempt {attempt} of {max}": "Esta etapa: tentativa {attempt} de {max}", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "Você pode navegar pelo app enquanto esta aba estiver aberta. Cada etapa concluída é salva; se a aba desconectar, retomaremos do último ponto salvo quando você voltar." },
  hi: { "1 · Research dossier": "1 · शोध दस्तावेज़", "2 · Compose answer": "2 · उत्तर तैयार करें", "Check evidence": "साक्ष्य जाँचें", "Research stages": "शोध के चरण", "Research started. Keep this tab open; every completed stage is saved.": "शोध शुरू हो गया है। यह टैब खुला रखें; हर पूरा चरण सहेजा जाता है।", "Save journey": "यात्रा सहेजें", "This stage: attempt {attempt} of {max}": "यह चरण: {max} में से प्रयास {attempt}", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "यह टैब खुला रहते हुए आप ऐप में कहीं भी जा सकते हैं। हर पूरा चरण सहेजा जाता है; टैब का संपर्क टूटने पर लौटते ही हम अंतिम सहेजे गए चरण से जारी रखेंगे।" },
  bn: { "1 · Research dossier": "1 · গবেষণা নথি", "2 · Compose answer": "2 · উত্তর রচনা", "Check evidence": "প্রমাণ যাচাই", "Research stages": "গবেষণার ধাপ", "Research started. Keep this tab open; every completed stage is saved.": "গবেষণা শুরু হয়েছে। এই ট্যাব খোলা রাখুন; প্রতিটি সম্পূর্ণ ধাপ সংরক্ষিত হয়।", "Save journey": "যাত্রা সংরক্ষণ", "This stage: attempt {attempt} of {max}": "এই ধাপ: {max}-এর মধ্যে চেষ্টা {attempt}", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "এই ট্যাব খোলা থাকলে আপনি অ্যাপের অন্যত্র যেতে পারেন। প্রতিটি সম্পূর্ণ ধাপ সংরক্ষিত হয়; সংযোগ বিচ্ছিন্ন হলে ফিরে এলে সর্বশেষ সংরক্ষিত ধাপ থেকে আবার শুরু হবে।" },
  ar: { "1 · Research dossier": "1 · ملف البحث", "2 · Compose answer": "2 · صياغة الإجابة", "Check evidence": "التحقق من الأدلة", "Research stages": "مراحل البحث", "Research started. Keep this tab open; every completed stage is saved.": "بدأ البحث. أبقِ علامة التبويب هذه مفتوحة؛ تُحفظ كل مرحلة مكتملة.", "Save journey": "حفظ الرحلة", "This stage: attempt {attempt} of {max}": "هذه المرحلة: المحاولة {attempt} من {max}", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "يمكنك التنقل داخل التطبيق ما دامت علامة التبويب مفتوحة. تُحفظ كل مرحلة مكتملة؛ وإذا انقطع الاتصال فسنستأنف من آخر نقطة محفوظة عند عودتك." },
  "zh-CN": { "1 · Research dossier": "1 · 研究资料包", "2 · Compose answer": "2 · 撰写答案", "Check evidence": "核查证据", "Research stages": "研究阶段", "Research started. Keep this tab open; every completed stage is saved.": "研究已开始。请保持此标签页打开；每个已完成阶段都会保存。", "Save journey": "保存旅程", "This stage: attempt {attempt} of {max}": "本阶段：第 {attempt} 次，共 {max} 次", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "只要此标签页保持打开，你可以在应用内自由浏览。每个已完成阶段都会保存；若标签页断开连接，回来后会从最近的检查点继续。" },
  ja: { "1 · Research dossier": "1 · リサーチ資料", "2 · Compose answer": "2 · 回答を構成", "Check evidence": "根拠を確認", "Research stages": "リサーチの段階", "Research started. Keep this tab open; every completed stage is saved.": "リサーチを開始しました。このタブを開いたままにしてください。完了した段階はすべて保存されます。", "Save journey": "ジャーニーを保存", "This stage: attempt {attempt} of {max}": "この段階：{max}回中{attempt}回目", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "このタブを開いたままなら、アプリ内を移動できます。完了した段階は保存され、接続が切れた場合も戻ったときに最新のチェックポイントから再開します。" },
  ko: { "1 · Research dossier": "1 · 조사 자료", "2 · Compose answer": "2 · 답변 구성", "Check evidence": "근거 확인", "Research stages": "조사 단계", "Research started. Keep this tab open; every completed stage is saved.": "조사가 시작되었습니다. 이 탭을 열어 두세요. 완료된 단계는 모두 저장됩니다.", "Save journey": "여정 저장", "This stage: attempt {attempt} of {max}": "이 단계: {max}회 중 {attempt}회", "You can move around the app while this tab stays open. Every completed stage is saved, so if the tab disconnects we resume from the latest checkpoint when you return.": "이 탭을 열어 둔 동안 앱 안에서 이동할 수 있습니다. 완료된 단계는 모두 저장되며, 연결이 끊기면 돌아왔을 때 최근 체크포인트부터 다시 시작합니다." },
};

for (const locale of Object.keys(researchProgressTranslations) as Array<Exclude<SupportedLocale, "en">>) {
  Object.assign(translations[locale], researchProgressTranslations[locale]);
}
...
const byokEnglishMessages: Record<string, string> = {
  "App-funded allowance": "App-funded allowance",
  "Bring your own OpenAI key": "Bring your own OpenAI key",
  "Connected for this tab": "Connected for this tab",
  "App-funded trial": "App-funded trial",
  "Guests receive up to $0.50 of app-funded research. Add your key for continued live use.": "Guests receive up to $0.50 of app-funded research. Add your key for continued live use.",
  "Your account receives up to $1.00 of app-funded research. Add your key for continued live use.": "Your account receives up to $1.00 of app-funded research. Add your key for continued live use.",
  "OpenAI API key": "OpenAI API key",
  "Replace key": "Replace key",
  "Use my key": "Use my key",
  "Key saved for this browser tab.": "Key saved for this browser tab.",
  "The key could not be saved.": "The key could not be saved.",
  "Key removed from this tab.": "Key removed from this tab.",
  "Session-only.": "Session-only.",
  "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.",
  "Using your OpenAI key": "Using your OpenAI key",
  "Continue with your own key": "Continue with your own key",
  "BYOK requests do not consume this app-funded dollar allowance.": "BYOK requests do not consume this app-funded dollar allowance.",
  "Guests can add an OpenAI key for live use beyond the $0.50 trial.": "Guests can add an OpenAI key for live use beyond the $0.50 trial.",
  "Add an OpenAI key for live use beyond the $1.00 allowance.": "Add an OpenAI key for live use beyond the $1.00 allowance.",
  "Manage key": "Manage key",
  "Add key": "Add key",
  "Close navigation": "Close navigation",
  Menu: "Menu",
  "Next turn settings": "Next turn settings",
  "Open navigation": "Open navigation",
  Personality: "Personality",
};

const byokLocalizedMessages: Record<Exclude<SupportedLocale, "en">, Record<string, string>> = {
  es: { "App-funded allowance": "Crédito financiado por la aplicación", "Bring your own OpenAI key": "Usa tu propia clave de OpenAI", "OpenAI API key": "Clave de API de OpenAI", "Key saved for this browser tab.": "Clave guardada para esta pestaña.", "The key could not be saved.": "No se pudo guardar la clave.", "Key removed from this tab.": "Clave eliminada de esta pestaña.", "Session-only.": "Solo durante esta sesión.", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "La clave se conserva en esta pestaña, se envía a CuriosityPedia solo para tus solicitudes a OpenAI y nunca se guarda en tu cuenta ni en la base de datos.", "Close navigation": "Cerrar navegación", Menu: "Menú", "Next turn settings": "Ajustes del siguiente turno", "Open navigation": "Abrir navegación", Personality: "Personalidad" },
  fr: { "App-funded allowance": "Crédit financé par l’application", "Bring your own OpenAI key": "Utiliser votre propre clé OpenAI", "OpenAI API key": "Clé API OpenAI", "Key saved for this browser tab.": "Clé enregistrée pour cet onglet.", "The key could not be saved.": "La clé n’a pas pu être enregistrée.", "Key removed from this tab.": "Clé supprimée de cet onglet.", "Session-only.": "Session uniquement.", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "La clé reste dans cet onglet, n’est envoyée à CuriosityPedia que pour vos requêtes OpenAI et n’est jamais enregistrée dans votre compte ni dans la base de données.", "Close navigation": "Fermer la navigation", Menu: "Menu", "Next turn settings": "Réglages de la prochaine étape", "Open navigation": "Ouvrir la navigation", Personality: "Personnalité" },
  de: { "App-funded allowance": "Von der App finanziertes Guthaben", "Bring your own OpenAI key": "Eigenen OpenAI-Schlüssel verwenden", "OpenAI API key": "OpenAI-API-Schlüssel", "Key saved for this browser tab.": "Schlüssel für diesen Tab gespeichert.", "The key could not be saved.": "Der Schlüssel konnte nicht gespeichert werden.", "Key removed from this tab.": "Schlüssel aus diesem Tab entfernt.", "Session-only.": "Nur für diese Sitzung.", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "Der Schlüssel bleibt in diesem Tab, wird nur für deine OpenAI-Anfragen an CuriosityPedia gesendet und nie in deinem Konto oder der Datenbank gespeichert.", "Close navigation": "Navigation schließen", Menu: "Menü", "Next turn settings": "Einstellungen für die nächste Runde", "Open navigation": "Navigation öffnen", Personality: "Persönlichkeit" },
  pt: { "App-funded allowance": "Crédito financiado pelo aplicativo", "Bring your own OpenAI key": "Use sua própria chave da OpenAI", "OpenAI API key": "Chave de API da OpenAI", "Key saved for this browser tab.": "Chave salva para esta aba.", "The key could not be saved.": "Não foi possível salvar a chave.", "Key removed from this tab.": "Chave removida desta aba.", "Session-only.": "Somente nesta sessão.", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "A chave fica nesta aba, é enviada ao CuriosityPedia apenas para suas solicitações à OpenAI e nunca é salva na sua conta ou no banco de dados.", "Close navigation": "Fechar navegação", Menu: "Menu", "Next turn settings": "Configurações da próxima etapa", "Open navigation": "Abrir navegação", Personality: "Personalidade" },
  hi: { "App-funded allowance": "ऐप द्वारा वित्तपोषित सीमा", "Bring your own OpenAI key": "अपनी OpenAI कुंजी इस्तेमाल करें", "OpenAI API key": "OpenAI API कुंजी", "Key saved for this browser tab.": "कुंजी इस ब्राउज़र टैब के लिए सहेजी गई।", "The key could not be saved.": "कुंजी सहेजी नहीं जा सकी।", "Key removed from this tab.": "कुंजी इस टैब से हटा दी गई।", "Session-only.": "केवल इस सत्र के लिए।", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "कुंजी इसी टैब में रहती है, केवल आपकी OpenAI अनुरोधों के लिए CuriosityPedia को भेजी जाती है और आपके खाते या डेटाबेस में कभी सहेजी नहीं जाती।", "Close navigation": "नेविगेशन बंद करें", Menu: "मेन्यू", "Next turn settings": "अगले चरण की सेटिंग", "Open navigation": "नेविगेशन खोलें", Personality: "व्यक्तित्व" },
  bn: { "App-funded allowance": "অ্যাপ-অর্থায়িত সীমা", "Bring your own OpenAI key": "নিজের OpenAI কী ব্যবহার করুন", "OpenAI API key": "OpenAI API কী", "Key saved for this browser tab.": "এই ব্রাউজার ট্যাবের জন্য কী সংরক্ষিত হয়েছে।", "The key could not be saved.": "কী সংরক্ষণ করা যায়নি।", "Key removed from this tab.": "এই ট্যাব থেকে কী সরানো হয়েছে।", "Session-only.": "শুধু এই সেশনের জন্য।", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "কীটি এই ট্যাবেই থাকে, শুধু আপনার OpenAI অনুরোধের জন্য CuriosityPedia-তে পাঠানো হয় এবং আপনার অ্যাকাউন্ট বা ডেটাবেসে কখনো সংরক্ষিত হয় না।", "Close navigation": "নেভিগেশন বন্ধ করুন", Menu: "মেনু", "Next turn settings": "পরবর্তী ধাপের সেটিংস", "Open navigation": "নেভিগেশন খুলুন", Personality: "ব্যক্তিত্ব" },
  ar: { "App-funded allowance": "رصيد ممول من التطبيق", "Bring your own OpenAI key": "استخدم مفتاح OpenAI الخاص بك", "OpenAI API key": "مفتاح واجهة OpenAI", "Key saved for this browser tab.": "حُفظ المفتاح لعلامة التبويب هذه.", "The key could not be saved.": "تعذر حفظ المفتاح.", "Key removed from this tab.": "أزيل المفتاح من علامة التبويب هذه.", "Session-only.": "لهذه الجلسة فقط.", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "يبقى المفتاح في علامة التبويب هذه ولا يُرسل إلى CuriosityPedia إلا لطلبات OpenAI الخاصة بك، ولا يُحفظ مطلقًا في حسابك أو قاعدة البيانات.", "Close navigation": "إغلاق التنقل", Menu: "القائمة", "Next turn settings": "إعدادات الجولة التالية", "Open navigation": "فتح التنقل", Personality: "الشخصية" },
  "zh-CN": { "App-funded allowance": "应用资助额度", "Bring your own OpenAI key": "使用你自己的 OpenAI 密钥", "OpenAI API key": "OpenAI API 密钥", "Key saved for this browser tab.": "密钥已保存到此浏览器标签页。", "The key could not be saved.": "无法保存密钥。", "Key removed from this tab.": "密钥已从此标签页移除。", "Session-only.": "仅限本次会话。", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "密钥仅保存在此标签页中，只会随你的 OpenAI 请求发送给 CuriosityPedia，绝不会保存到你的账户或数据库。", "Close navigation": "关闭导航", Menu: "菜单", "Next turn settings": "下一轮设置", "Open navigation": "打开导航", Personality: "角色风格" },
  ja: { "App-funded allowance": "アプリ負担枠", "Bring your own OpenAI key": "自分の OpenAI キーを使う", "OpenAI API key": "OpenAI API キー", "Key saved for this browser tab.": "このブラウザータブにキーを保存しました。", "The key could not be saved.": "キーを保存できませんでした。", "Key removed from this tab.": "このタブからキーを削除しました。", "Session-only.": "このセッションのみ。", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "キーはこのタブ内に保持され、OpenAIへのリクエスト時だけCuriosityPediaに送信されます。アカウントやデータベースには保存されません。", "Close navigation": "ナビゲーションを閉じる", Menu: "メニュー", "Next turn settings": "次のターンの設定", "Open navigation": "ナビゲーションを開く", Personality: "個性" },
  ko: { "App-funded allowance": "앱 지원 한도", "Bring your own OpenAI key": "내 OpenAI 키 사용", "OpenAI API key": "OpenAI API 키", "Key saved for this browser tab.": "이 브라우저 탭에 키를 저장했습니다.", "The key could not be saved.": "키를 저장할 수 없습니다.", "Key removed from this tab.": "이 탭에서 키를 제거했습니다.", "Session-only.": "이 세션에서만 사용됩니다.", "The key is kept in this tab, sent only to CuriosityPedia for your OpenAI requests, and never saved to your account or database.": "키는 이 탭에만 보관되며 OpenAI 요청을 위해서만 CuriosityPedia로 전송되고 계정이나 데이터베이스에는 저장되지 않습니다.", "Close navigation": "탐색 닫기", Menu: "메뉴", "Next turn settings": "다음 턴 설정", "Open navigation": "탐색 열기", Personality: "성격" },
};

for (const locale of Object.keys(byokLocalizedMessages) as Array<Exclude<SupportedLocale, "en">>) {
  Object.assign(translations[locale], byokEnglishMessages, byokLocalizedMessages[locale]);
}
