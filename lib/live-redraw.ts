  ...
  try {
    response = await requestOpenAI({
      ...
      instructions: [
        ...
        "Make each one a playable rabbit hole with the natural-language length of 5–12 English words, using the output language's normal segmentation and syntax. Use plain everyday language, one idea at a time, and wording that is fun to say out loud. Ask about something the learner can picture: what it does, why it happens, how it works, what might happen if it changed, or what it can be compared with.",
        ...(performer.id === "atlas" ? ["For Atlas, do not create hypothetical or counterfactual paths. Both options must stay attached to documented real subjects, events, or observed phenomena."] : []),
